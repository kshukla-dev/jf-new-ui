...
<style scoped>
/* Base container classes for CTA */
.eor-container {
  max-width: 1440px;
  margin: 0 auto;
  padding: 0 5%;
...
.cta-banner {
  background: linear-gradient(180deg, #fbf7f1 0%, #f2e8dd 100%);
  color: var(--ink, #061639);
  text-align: center;
  padding: 72px 30px 42px;
  border-radius: 28px;
  margin: 80px auto 64px;
  border: 1px solid rgba(186, 136, 120, 0.24);
  box-shadow: 0 28px 90px rgba(186, 136, 120, 0.14);
  position: relative;
  overflow: hidden;
}
...
.cta-banner h2 {
  color: var(--ink, #061639);
  font-family: var(--gh-serif, 'Libre Caslon Text', serif);
  font-size: 44px;
  margin-bottom: 16px;
...
.cta-banner p {
  color: var(--gh-on-surface-variant, #4a4d57);
  font-size: 18px;
  margin: 0;
  line-height: 1.75;
}
...
.cta-eyebrow-text {
  font-family: var(--gh-sans, 'Hanken Grotesk', sans-serif);
  font-size: 11px;
  font-weight: 700;
...
.cta-card-new {
  background: #ffffff87;
  border: 1px solid rgba(176, 149, 89, 0.12);
  border-radius: 16px;
  padding: 36px 24px;
  display: flex;
...
.cta-card-new:hover {
  ...
  box-shadow: 0 18px 40px rgba(176, 149, 89, 0.08);
}
...
.btn-cta-gold {
  ...
  box-shadow: 0 8px 20px rgba(176, 149, 89, 0.25);
}

.btn-cta-gold:hover {
  background: #947a44;
  transform: translateY(-1px);
  box-shadow: 0 10px 24px rgba(176, 149, 89, 0.35);
}
