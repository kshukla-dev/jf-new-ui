    ...
    <div class="container footer-container">
        ...
        <div class="footer-newsletter">
          ...
          <div class="newsletter-form">
            <div class="input-wrap">
              ...
              <svg class="mail-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
            </div>
      ...
      <div class="footer-trust">
        <div class="trust-companies">
          <span class="trust-title">Trusted by 700+ companies worldwide</span>
          <div class="trust-logos">
            <span class="mock-logo"><svg viewBox="0 0 24 24" width="16" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle></svg> Payoneer</span>
            <span class="mock-logo"><svg viewBox="0 0 24 24" width="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 22h20L12 2z"></path></svg> airbnb</span>
            <span class="mock-logo"><svg viewBox="0 0 24 24" width="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg> Shopify</span>
            <span class="mock-logo">docusign</span>
            <span class="mock-logo"><b>DHL</b></span>
            <span class="mock-logo"><svg viewBox="0 0 24 24" width="16" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><path d="M8 11.5c2.5-1 6-1 8 0M8 15c2.5-1 6-1 8 0M9 8c2-1 4-1 6 0"></path></svg> Spotify</span>
            <span class="mock-logo"><i>Canva</i></span>
          </div>
        </div>
        <div class="trust-certs">
          <span class="trust-title">Certifications &amp; Compliance</span>
          <div class="trust-logos certs">
            <span class="mock-cert"><svg viewBox="0 0 24 24" width="20" fill="none" stroke="currentColor" stroke-width="1.5"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg> ISO 27001</span>
            <span class="mock-cert"><svg viewBox="0 0 24 24" width="20" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> GDPR</span>
            <span class="mock-cert"><svg viewBox="0 0 24 24" width="20" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg> SOC 2</span>
          </div>
        </div>
      </div>
      ...
      <div class="footer-bottom">
        <div class="fb-left">
          © {{ year }} Jackson &amp; Frank. All rights reserved.
        </div>
        <div class="fb-right">
          <span class="fb-v">v2.0.0</span>
          <span class="fb-sep">|</span>
          <RouterLink to="/privacy-policy">Privacy Policy</RouterLink>
          <span class="fb-sep">|</span>
          <RouterLink to="/sitemaps">Sitemap</RouterLink>
