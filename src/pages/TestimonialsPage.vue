...
.testimonials-hero {
  ...
  background-image: linear-gradient(90deg, #f4f1ec 0%, rgb(244 241 236 / 10%) 30%, rgba(253, 251, 247, 0.4) 60%, rgba(253, 251, 247, 0) 100%), url(/services/service-page/hiringGlobally.png);
...
@media (max-width: 640px) {
  .testimonials-hero {
    ...
    background-image: linear-gradient(to bottom, rgba(244, 241, 236, 0) 0%, rgba(244, 241, 236, 0.15) 60%, #f4f1ec 250px), url(/services/service-page/hiringGlobally.png);
  }
  .testimonials-hero-inner {
    padding-left: 0;
    padding-right: 0;
...
.highlight-card:hover {
  transform: translateY(-4px);
  border-color: rgba(176, 149, 89, 0.4);
