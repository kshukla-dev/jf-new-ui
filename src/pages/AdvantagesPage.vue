...
.advantages-hero {
  ...
  background-image: linear-gradient(90deg, #f4f1ec 0%, rgb(244 241 236) 30%, rgba(253, 251, 247, 0.4) 60%, rgba(253, 251, 247, 0) 100%), url(/services/service-page/advantages.png);
...
.adv-card {
  ...
  padding: 38px 34px;
  box-shadow: 0 20px 40px rgba(115, 78, 42, 0.06);
...
.adv-num {
  ...
  font-size: 20px;
  margin-bottom: 22px;
  box-shadow: 0 4px 10px rgba(176, 149, 89, 0.2);
}
.adv-card h3 {
  font-family: var(--serif);
  font-size: 24px;
...
.cert-card {
  background: var(--bg);
  border: 1px solid rgba(160, 125, 77, 0.15);
  border-radius: var(--radius-lg);
  padding: 36px 32px;
...
.cert-card-header {
  ...
  margin-bottom: 20px;
  padding-bottom: 16px;
  border-bottom: 1px solid rgba(160, 125, 77, 0.12);
}
.cert-icon-wrapper {
  display: flex;
  align-items: center;
  ...
  height: 56px;
  background: #ffffff;
  border: 1px solid rgba(160, 125, 77, 0.12);
  border-radius: 50%;
  overflow: hidden;
  padding: 6px;
  flex-shrink: 0;
...
.faq-tab.active {
  background: white;
  color: var(--accent);
  box-shadow: 0 2px 8px rgba(176, 149, 89, 0.12);
}
.faq-list {
  display: flex;
  flex-direction: column;
