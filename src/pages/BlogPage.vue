      ...
      <div class="container blog-hero-inner">
        ...
        <div class="hero-floating-cards">
          ...
          <RouterLink to="/blog" class="float-card card-3">
            <div class="float-card-img-wrap"><img src="/services/service-page/compliances.webp" alt="Compliance" class="float-card-img" /></div>
            <div class="float-card-body">
    ...
    <section class="section container">
      ...
      <div v-if="loading" class="blog-main-layout">
        <div class="blog-main-content">
          <div v-for="i in 4" :key="i" class="blog-card blog-card-skeleton">
      ...
      <div v-else class="blog-main-layout">
        ...
        <div class="blog-main-content">
          <div class="section-heading">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="#b09559" stroke="none"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
        ...
        <aside class="blog-sidebar">
          ...
          <div class="sidebar-widget newsletter-widget">
            <div class="section-heading">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b09559" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
              <h2>Stay Updated</h2>
            </div>
          ...
          <div class="sidebar-widget topics-widget">
            <div class="section-heading">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#b09559" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
...
.float-card {
  ...
  align-items: center;
  gap: 10px;
  box-shadow: 0 12px 30px rgba(176, 149, 89, 0.08);
  pointer-events: auto;
...
.float-card:hover {
  ...
  box-shadow: 0 16px 40px rgba(176, 149, 89, 0.12);
}
.float-card-img-wrap {
  width: 44px;
  height: 44px;
...
.featured-card:hover {
  transform: translateY(-4px);
  box-shadow: 0 20px 40px rgba(176, 149, 89, 0.1);
}
.featured-card-body {
  padding: 48px;
  display: flex;
...
.btn-outline-gold:hover {
  background: rgba(199, 164, 86, 0.05);
}
...
.resources-icon {
  ...
  justify-content: center;
  color: var(--accent);
  box-shadow: 0 4px 16px rgba(176, 149, 89, 0.1);
  flex-shrink: 0;
}
