...
.home-hero {
  ...
  display: block;
  background-color: #f4f1ec;
  background-image: linear-gradient(90deg, #f4f1ec 0%, rgb(244 241 236) 30%, rgba(253, 251, 247, 0.4) 60%, rgba(253, 251, 247, 0) 100%), url(/services/service-page/about2.png);
  background-size: 60% auto;
  background-position: right 0% center;
  background-repeat: no-repeat;
  color: var(--ink);
